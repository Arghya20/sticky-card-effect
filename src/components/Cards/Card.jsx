...
const Card = ({ data, stickyTopSpace }) => {
  ...
  return (
    <div
      className={`sticky grid grid-cols-1 overflow-hidden rounded-xl bg-blue-100 card shadow-[0px_0px_30px_-10px_rgba(0,0,0,0.1)] md:grid-cols-2 border  border-gray-600`}
